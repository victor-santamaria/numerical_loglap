...
\author{V\'ictor Hern\'andez-Santamar\'ia
\footnote{Instituto de Matem\'aticas,
Universidad Nacional Aut\'onoma de M\'exico. 
Circuito Exterior, Ciudad Universitaria
04510 Coyoac\'an, Ciudad de M\'exico, Mexico,\newline victor.santamaria@im.unam.mx}\hspace{0.5ex},
 Sven Jarohs
\footnote{Institut f\"ur Mathematik,
Goethe-Universit\"at Frankfurt.
Robert-Mayer-Str. 10,
D-60629 Frankfurt am Main, Germany, jarohs@math.uni-frankfurt.de}\hspace{0.5ex}, 
Alberto Salda\~{n}a
\footnote{Instituto de Matem\'aticas,
Universidad Nacional Aut\'onoma de M\'exico. 
Circuito Exterior, Ciudad Universitaria
04510 Coyoac\'an, Ciudad de M\'exico, Mexico,\newline alberto.saldana@im.unam.mx}\hspace{0.5ex}, and 
Leonard Sinsch
\footnote{Institut f\"ur Mathematik,
Goethe-Universit\"at Frankfurt.
Robert-Mayer-Str. 10,
D-60629 Frankfurt am Main, Germany, leo\_s1996@web.de} 
}
...
\node at (0,0) {\includegraphics[width=\textwidth]{overview_ri.eps}};

\draw (0.6,-5.3) node[circle,color=white,fill=white,minimum size=1cm,draw] (A) {};
\node at (A) {\large $L$};

\draw[draw=white,fill=white] (-8.5,-0.9) rectangle ++(0.8,3);

\node[rotate=90] at (-8.2,0)   {\large $\textnormal{cond}\mathcal{A}^L_h$};
