...
Lastly, \Cref{Fig:blow} illustrates the behavior of the torsion function as \( L \to L_1 \). Since this corresponds to an eigenvalue approaching zero, we expect the function to blow up in this limit, which is indeed observed in the figure. Moreover, as \( L \to L_1^- \), the solution changes sign, reflecting the fact that the first eigenvalue becomes negative.
