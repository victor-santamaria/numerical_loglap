...
\small
	...
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{sol-log_convergence_data_04-02-2025_19h19.org}\solution      
	...
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{sol-log_convergence_data_04-02-2025_19h19.org}\data      
...
\centering
%
\pgfplotstableread{sol-log_convergence_data_04-02-2025_19h41.org}\data
%
\pgfplotstableset{
columns={N,h,L2norm,slopeL2,L2locnorm,slopeL2loc,Linfnorm,slopeinf},
%%%
...
\begin{figure}[htb]
	...
	\begin{tikzpicture}[scale=0.6]
	\begin{axis}[xlabel={$x$},xmin=-0.1,xmax=0.1,legend pos=outer north east,
	legend plot pos=left, xtick={-0.1,0,0.1}, xticklabels={-0.1,0,0.1}, ymin=-0.02,
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{eig-log_05-02-2025_17h41.org}\solution      
	...
	\begin{tikzpicture}[scale=0.6]
	\begin{axis}[xlabel={$x$},xmin=-1,xmax=1,legend pos=outer north east,
	legend plot pos=left, xtick={-1,0,1}, xticklabels={-1,0,1}, ymax=0,
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{eig-log_05-02-2025_17h20.org}\solution      
	...
	\caption{Numerical approximation of the first and second eigenfunctions of \( L_{\Delta} \) for  $L = 0.1$ (top) and $L = 1$ (bottom).
}
	\label{Fig:eigen}
\end{figure}
