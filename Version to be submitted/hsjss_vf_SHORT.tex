...
The proof of \Cref{lem:stab_dif_interp_weight} is analogous to the one of \Cref{lem:stab_dif_interp} and few changes are needed. More precisely, $J_1$ can be directly estimated as 
...
\end{equation}
and $J_2$ can be estimated with the help of \Cref{lem:poincare_type_weight}. For brevity, we skip the details. 
...
\centering
%
\pgfplotstableread{sol-log_convergence_data_06-02-2025_10h05.org}\data
%
\pgfplotstableset{
