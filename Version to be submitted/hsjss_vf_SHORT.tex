...
\begin{align}\label{eq:def_basis}
 \varphi_i(x)=\begin{cases}
    ...
    \end{cases}
\end{align}
Note that $\varphi_i(x_j)=\delta_{ji}$.  As explained in the introduction, we also need to consider
%
...
Let $v\in L^2(\Omega)$ and $a_k$ as in \eqref{eq:interpolator}. There is $C>0$ independent of $h$ such that
%
...
\displaystyle \frac{\mathsf q_k}{6}, & \textnormal{$i,j\in\inter{1,N}$ and $\blue{k:=}j-i> 2$,} \\
