...
\end{align}
which is a way to approximate\footnote{For instance, the norms $\|L_\Delta u-f\|_{L^2}$ and $\|u-v_h\|_{L^2}$ can be approximated numerically, this gives an estimate on $\|u_h-v_h\|_{L^2}$ due to the stability of discrete problems, and then
$\|u-u_h\|_{L^2}\leq \|u-v_h\|_{L^2}+\|v_h-u_h\|_{L^2}.$
