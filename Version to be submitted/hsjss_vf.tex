...
\end{equation}
%
%\B{where $C>0$ is a constant that depends on $L$, $|v|_{\infty}$, $|v^\prime|_{\infty}$, but independent of $h$.}
\end{proposition}
...
\begin{figure}[htb]
	...
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{sol-log_num-vs-exact_20-06-2023_12h48.org}\solution   
	...
	\caption{A comparison between $u$ given by \eqref{udef} and $v_h$ given by \eqref{vdef} for $N=50$. \Bc{sacar grafica plot de u-uh}}
	\label{fig:2}
\end{figure}
