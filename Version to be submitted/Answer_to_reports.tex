...
Thank you for your comment. Indeed, Proposition 3.8 is meaningful for regular functions, and we agree that higher-order estimates might be expected in this context. To address this, we have improved Lemma A.2, which concerns the behavior of functions near the boundary with the $\ell$ function. This improvement has been incorporated into the revised version of Proposition 3.8. However, determining the optimality of such estimates requires a deeper understanding of the regularity of functions in the space $u \in \mathbb{H}(\Omega)$ near the boundary and how this affects the decomposition of the norm carried out in Lemma 3.1. This remains an open question.
