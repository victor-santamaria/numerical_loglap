...
\begin{figure}[htbp]
	...
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{./Programas/num_results/sol-log_num-vs-exact_20-06-2023_15h33.org}\solution      
	...
	\subfloat[]{
	\begin{tikzpicture}[scale=0.8]
	\begin{axis}[xlabel={$x$},xmin=-1,xmax=1,ymin=0.5,legend pos=outer north east,
	legend plot pos=left, xtick={-1,0,1},
	legend style={cells={anchor=west},draw=none}]
	%	    
	\pgfplotstableread{./Programas/num_results/sol-log_num-vs-exact_20-06-2023_15h43.org}\solution      
